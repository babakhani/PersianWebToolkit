...
var Parser = function () {
    ...
    _createClass(Parser, [{
        ...
        value: function parse(inputString) {
            var that = this;
            var persianDateArray = void 0;
            var jalaliPat = new RegExp(that.pattern.jalali);

            inputString = this.convertPersianDigit(inputString);
        ...
        key: 'convertPersianDigit',
        value: function convertPersianDigit($string) {
